                                ...
                                <div id="recipeCarousel" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        @foreach($cust_testimonies as $custtestimoni)
                                            ...
                                            <div class="modal fade" id="testimonyModal{{ $custtestimoni->idCustTestimoni }}" tabindex="-1" aria-labelledby="testimonyModalLabel{{ $custtestimoni->id }}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="testimonyModalLabel{{ $custtestimoni->id }}">{{$custtestimoni->custName}} - {{$custtestimoni->companyName}}</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <img src="{{ url('public/images/'.$custtestimoni->imgFilepath) }}" class="img-fluid mb-3" alt="Customer Image">
