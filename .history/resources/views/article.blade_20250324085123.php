                    ...
                    {{-- @php echo '<div class="row">'; @endphp --}}
                        ...
                        @foreach ($articles as $article)
                            ...
                            @php echo '<div class="col-lg-4 col-md-4 tm-info-box">'; @endphp
                                <img id='preview-image-before-upload' src='{{ url('public/images/'.$article->imgFilepath) }}' alt='preview image' class='img-center' style="border-radius: 5px 5px 0 0; object-fit: cover; width: 100%; height: 200px;">
