        ...
        <section id="article" class="article-list">
            <div class="container">
                <div class="article-data">
                    ...
                    <div class="title">
                        <h1 style="font-size: 56px; font-weight: bold;">{{$article->titleArticle}}</h1>
                    </div>
                    <p style="font-size: 16px; font-style: italic; color: #88BBF2; text-align: center; ">{{$dt}}</p>
                    <img id='preview-image-before-upload' src='{{ url('public/images/'.$article->imgFilepath) }}' alt='preview image' class='img-detail' style="padding:10px">
                </div>
                <div class="textarea" style="max-width: 800px; margin: auto; padding: 10px"><p class="p mb-4">{!! $article->textArticle !!}</p></div>
            </div>
            <!-- Back to Top link -->
            <div class="back-to-top-wrapper">
                <a href="#top" class="back-to-top-link" style="font-size: 16px" aria-label="Scroll to Top">Back to top</a>
            </div>
