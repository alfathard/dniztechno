                    ...
                    {!! Form::open(['action' => 'App\Http\Controllers\ArticlesController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'files' => true]) !!}
                      @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-11">
                                {{Form::textarea('textArticle', '', ['class' => 'form-control textArticle', 'placeholder' => 'Text'])}}
                            </div>
                        </div>
        ...
        <script type="text/javascript">
          ...
          CKEDITOR.replace( 'editor1' ,{
            toolbar: [
                ...
                [ 'Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Redo' ,'-', 'Table', 'Blockquote', 'HorizontalRule'],
