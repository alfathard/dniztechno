...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body id="home">
        <div class="ss-heading-warp" style="height: 70%">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                        <div class="collapse navbar-collapse" id="navbarResponsive">
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="/product/show/{{$idps}}">Paket</a>
                                </li>
                                {{-- <li class="nav-item">
                    ...
                    <div class="our-product-data">
                        @if(count($productheaders) > 0)
                            @foreach($productheaders as $productheader)
                                <div class="title">
                                    <h1 style="font-size: 60px; font-style: bold;">{{$productheader->titleProductHeader}}</h1>
                                </div>
                                <div class="content">
                        ...
                        @else
                            ...
                            <div class="content">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis blandit sit amet ipsum eget pretium. Cras condimentum lorem non quam ullamcorper vulputate. Integer nec blandit libero, in aliquam metus. Sed ullamcorper lacus et ex auctor aliquam.

                                    Curabitur ultricies erat dolor, sit amet volutpat nibh molestie at. Vivamus orci nulla, fringilla nec ante at, venenatis dapibus odio. Sed quis lobortis ipsum. Mauris sed diam et nunc tincidunt faucibus.
                                </p>
                            </div>
                        @endif
                    </div>
        ...
        <section id="product" class="product-list">
            ...
            <div class="row justify-content-center" style="margin-top:-250px; --bs-gutter-x : 0">
                @if(count($products) > 0)
            ...
            {{-- <div class="used">
                ...
                @if(count($productuseds) > 0)
                    @foreach($productuseds as $productused)
                        <div class="ss-image" style="background-image: url('{{ url('public/images/'.$productused->imgFilepath) }}')"></div>
                        <p class="card-text">{{$productused->textProductUsed}}</p>
                    @endforeach
                @else
        ...
        <section id="testimoni">
            <div class="ss-featuring">
                ...
                @endif     --}}
                <div class="ss-featuring">
                    <div class="row justify-content-center row-cols-5" style="--bs-gutter-x :0" >
