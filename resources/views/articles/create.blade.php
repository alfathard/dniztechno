                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <img id="preview-image-before-upload"
                                         src="/public/images/product_image_not_found.gif" alt="preview image"
...
{{--            <script src="/plugin/ckeditor/ckeditor.js"></script>--}}
            ...
            <script type="text/javascript">
                ...
                CKEDITOR.replace('editor1', {
                    ...
                    toolbar: [
                        ['Bold', 'Italic', 'Font', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink', 'Image'],
                        ['Cut', 'Copy', 'Paste', 'Pas   teText', 'PasteFromWord', '-', 'Undo', 'Redo', '-', 'Blockquote', 'HorizontalRule'],
