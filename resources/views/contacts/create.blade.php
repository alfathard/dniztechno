                    ...
                    {!! Form::open(['action' => 'App\Http\Controllers\ContactsController@store', 'method' => 'POST']) !!}
                      @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-sm-11">
                              {{Form::text('titleContactUs', '', ['class' => 'form-control form-control-lg', 'placeholder' => 'Title'])}}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-11">
                                {{Form::textarea('textContactUs', '', ['class' => 'form-control form-control-sm', 'placeholder' => 'Text'])}}
                            </div>
                        </div>  
