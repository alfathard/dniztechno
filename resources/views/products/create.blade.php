          ...
          <div class="col-12">
            <div class="btn-group" role="group" aria-label="btngroup">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['action' => 'App\Http\Controllers\ProductsController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'files' => true]) !!}
                      @csrf
                        <div class="form-group row">
                            {{Form::label('nameProduct','Type',['class' => 'col-sm-1 col-form-label'])}}
                            <div class="col-sm-11">
                              {{Form::text('nameProduct', '', ['class' => 'form-control form-control-lg', 'placeholder' => 'Name of the product'])}}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-11">
                                {{Form::text('descProduct', '', ['class' => 'form-control form-control-sm', 'placeholder' => 'Description of the product'])}}
                            </div>
                        </div>  
