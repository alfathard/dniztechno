          ...
          <div class="col-12">
            <div class="btn-group" role="group" aria-label="btngroup">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['action' => 'App\Http\Controllers\TestimoniesController@store', 'method' => 'POST']) !!}
                      @csrf
                        <div class="form-group row">
                            {{Form::label('titleTestimoni','Title',['class' => 'col-sm-1 col-form-label'])}}
                            <div class="col-sm-11">
                              {{Form::text('titleTestimoni', '', ['class' => 'form-control form-control-lg', 'placeholder' => 'Title'])}}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-11">
                                {{Form::textarea('textTestimoni', '', ['class' => 'form-control form-control-sm', 'placeholder' => 'Text'])}}
                            </div>
                        </div>  
